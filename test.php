...
<style>
  ...
  .carousel-inner .carousel-item img.vertical {
    border-left: 1px solid #ddd; /* Adicione borda à esquerda */
    border-right: 1px solid #ddd; /* Adicione borda à direita */
  }
</style>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" style="max-width: 500px; margin: 0 auto;">
                ...
                <div class="carousel-inner">
                    ...
                    foreach ($fotos as $index => $foto) {
                        $imageClass = (exibirImagemVertical($foto)) ? 'vertical' : '';
                        ?>
                        <div class="carousel-item <?php echo ($index === 0) ? 'active' : ''; ?>">
                            <img src="<?php echo htmlspecialchars(trim($foto)); ?>" class="d-block w-100 <?php echo $imageClass; ?>" alt="Imagem da notícia">
                        </div>
                        <?php
                    }
                    ?>
