...
<body>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Gestão e Conteúdo - Páginas "Sobre Nós" e "A Nossa Formação"</h1>
        <form action="" method="POST">
            <div class="mb-3">
                <label for="acao" class="form-label">Selecione uma ação:</label>
                <select name="acao" id="acao" class="form-select">
                    <option value="">Selecione</option>
                    <option value="adicionar">Sobre Nós</option>
                    <option value="editar">A Nossa Formação</option>
                </select>
            </div>
        ...
        <?php
            ...
            if (isset($_POST['acao'])) {
                ...
                if ($acao === 'adicionar') {
                    header("Location: gerir-sobre-nos.php");
                    exit;
                } elseif ($acao === 'editar') {
                    header("Location: gerir-a-nossa-formacao.php");
                    exit;
                }
            }
        ?>
