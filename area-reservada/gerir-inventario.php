...
<body>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Gerir Inventário</h1>
        ...
        <?php
            ...
            if (isset($_POST['acao'])) {
                ...
                if ($acao === 'adicionar') {
                    header("Location: adicionar-inventario.php");
                    exit;
                } elseif ($acao === 'editar') {
                    // Adicione o código para editar inventário aqui
                    header("Location: editar-inventario.php");
                    exit;
                }  elseif ($acao === 'consultar') {
                    // Adicione o código para editar inventário aqui
                    header("Location: consultar-inventario-todo.php");
                    exit;
                }  elseif ($acao === 'atribuir') {
                    // Adicione o código para editar inventário aqui
                    header("Location: atribuir-inventario.php");
                    exit;
                } elseif ($acao === 'eliminar') {
                    header("Location: eliminar-inventario.php");
                    exit;
                }
            }
        ?>
